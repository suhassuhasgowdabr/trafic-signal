...
export class Rou1Component {
  img_url: string = "assets/images/red.jpg";
  s: boolean = true;
  timer: number = 4000;
  intervalId: any;
  img_url1:string = "assets/images/red1.jpeg"
...
countdown(seconds: number) {
  ...
  changeLight() {
    ...
    if (this.img_url === "assets/images/red.jpg") {
      this.img_url1 = "assets/images/red1.jpeg";
      this.str = "Stop your vehicle until the green light appears";
      this.countdown(3);
    } else if (this.img_url === "assets/images/yellow.jpg") {
      this.img_url1 = "assets/images/yellow1.jpeg";
      this.str = "Prepare to proceed with caution,the signal is transitioning to green"; 
      this.countdown(3);
    } else {
      this.img_url1 = "assets/images/green1.jpeg";
      this.str = "You may proceed, the road is clear"; 
      this.countdown(3);
    }
}
